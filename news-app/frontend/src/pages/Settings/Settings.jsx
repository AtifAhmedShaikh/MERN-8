...
const Settings = () => {
  ...
  useEffect(() => {
    // Apply dark mode styles or classes based on the state
  ...
  return (
    <React.Fragment>
      ...
      <Container className="flex flex-col items-center mt-4">
        <div className="lg:w-[45%] border-b flex justify-between px-3 py-3">
          <label
          ...
          <input
            className="mr-2 mt-[0.3rem] h-3.5 w-8 appearance-none rounded-[0.4375rem] bg-neutral-300 ... dark:text-white"
            type="checkbox"
            role="switch"
            id="toggle-1"
            checked={darkMode}
